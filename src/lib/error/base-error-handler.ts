...
export class BaseError extends Error {
    ...
    // 메시지 생성 로직
    private static formatMessage(code: BaseErrorCode, meta?: Record<string, unknown>): string {
...
export async function withBaseErrorHandler<T>(operation: () => Promise<T>): Promise<T> {
    try {
